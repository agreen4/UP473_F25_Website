...
Use the [following link](https://uofi.box.com/s/dqye636xyx3kwm4k6s1o7ibdei3xtvtj) to sign up for a [policy memo](../assignments/05_facilitation.qmd) topic. This topic should in some way related to the "big picture" question associated with that portion of the course. Your policy memo does not need to correspond to a theme of one of the course sessions in that big picture area.
