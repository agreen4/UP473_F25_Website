...
In this session, we will examine the unique housing needs and trends, and policy solutions associated with houselessness. 

## Learning Goals

-   Understand common standards for measuring homelessnes.
-   Understand how local continuums of care provide services.
-   Envision how housing policy might respond to the housing needs of individuals without regular access to a house.

## Readings

Schwartz 12

Introduction to *The Undeserving Poor* by Michael Katz [{{< fa arrow-up-right-from-square >}}](https://uofi.box.com/s/ciy03bjrvvpv5xh08gke3jhgk531wt3e)

State of Homelessness 2024 Edition (skim) [{{< fa arrow-up-right-from-square >}}](https://endhomelessness.org/homelessness-in-america/homelessness-statistics/state-of-homelessness/)
...
Yarusso on [Houselessness](https://uofi.box.com/s/72o5mddtqcvs4e8rhqt94a9rl0t5kt7r)
